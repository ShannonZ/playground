...
namespace RayCasting3
{
    class RenderWindow:GameWindow
    {
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            InitFrameBuffer(backfaceTex, Width, Height);
            InitShaderProgram();
        }
        ...
        private void InitFace2DTex(int texWidth, int texHeight)
        {
            ...
            GL.TexImage2D(TextureTarget.Texture2D, 0, PixelInternalFormat.Rgb16f, texWidth, texHeight, 0, PixelFormat.Rgba, PixelType.Float, IntPtr.Zero);
        }
        #endregion
        ...
        private void Render(CullFaceMode cullFace)
        {
            ...
            model *= Matrix4.CreateRotationZ(MathHelper.DegreesToRadians(zdeg));
